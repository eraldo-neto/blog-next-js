import { CategoryCard, TitleCard, CardMetas, CardMeta, CardContent, CardImage } from "../../styles/common";
        ...
        <Card className="postCard">
            ...
            <CardContent className="cardContent">
                ...
                <CardMetas className="metasWrapper">
                    ...
                    <CardMeta>
                        <svg id="Camada_1" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><defs><clipPath id="clip-path" transform="translate(-6.41 -5.56)"><path class="cls-1-clock" d="M15.41,5.56a9,9,0,0,1,9,9,9.67,9.67,0,0,1-.08,1.2,9,9,0,1,1-8.92-10.2Z"></path></clipPath><linearGradient id="Gradiente_sem_nome_3" x1="8.01" y1="1826.37" x2="5.97" y2="1827.64" gradientTransform="matrix(18, 0, 0, -18, -114.6, 32898.04)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#7a1ea1"></stop><stop offset="1" stop-color="#48e4ff"></stop></linearGradient><linearGradient id="clock-grad" x1="18.62" y1="1866.84" x2="16.58" y2="1868.1" gradientTransform="matrix(6.27, 0, 0, -7.08, -94.7, 13237.84)"></linearGradient></defs><g class="cls-2-clock"><g id="Grupo_de_máscara_30" data-name="Grupo de máscara 30"><g id="clock"><g id="Grupo_1184" data-name="Grupo 1184"><path id="Caminho_132" data-name="Caminho 132" class="cls-3-clock" d="M15.41,5.56a9,9,0,1,0,9,9A9,9,0,0,0,15.41,5.56Zm0,16.09a7.09,7.09,0,1,1,7.08-7.09h0A7.1,7.1,0,0,1,15.41,21.65Z" transform="translate(-6.41 -5.56)"></path><path id="Caminho_133" data-name="Caminho 133" class="cls-4-clock" d="M20.1,14.28h-4V9.42a.75.75,0,0,0-1.49,0V15a.74.74,0,0,0,.74.74H20.1a.74.74,0,0,0,0-1.48Z" transform="translate(-6.41 -5.56)"></path></g></g></g></g></svg>
